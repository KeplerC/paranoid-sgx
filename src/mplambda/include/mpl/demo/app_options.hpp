...
namespace mpl::demo {
    ...
    public:
        inline AppOptions() {}
        AppOptions(hello_world::MP_Lambda_Input lambda_input);
        ...
        void setKVSClient(asylo::KVSClient *_kvsClient){
        ...
        asylo::KVSClient *KVSClient() const {
            return kvsClient;
        }
